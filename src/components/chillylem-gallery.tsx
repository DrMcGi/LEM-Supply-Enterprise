...
export function ChillylemGallery({ images }: ChillylemGalleryProps) {
        ...
        {activeImage ? (
          <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <div className="flex flex-col justify-between gap-6 rounded-[1.75rem] border border-white/70 bg-linear-to-br from-white via-teal-50/55 to-amber-50/55 p-6 shadow-[0_24px_70px_-48px_rgba(0,0,0,0.24)]">
              <div>
                <p className="text-xs uppercase tracking-[0.22em] text-teal-700">Image {activeIndex + 1} of {images.length}</p>
            ...
            return (
              ...
              >
                ...
                <div className="px-4 py-4">
                  ...
                  <p className="mt-2 text-lg font-bold text-stone-900">Gallery Image {index + 1}</p>
                </div>
              </button>
            );
          })}
